...
### Option 1: Add Test Coverage

- Test ชื่อว่าง (`''`) ลดความเสี่ยงที่ขอบเขตของ input จะทำให้รูปแบบข้อความผิดพลาด
- Test ชื่อภาษาไทย (`นักเรียนคลาวด์`) ลดความเสี่ยงที่ application หรือ test จะจัดการ Unicode input ไม่ถูกต้อง
